#This is a GUI program for the top commonly used
#Vienna RNA programs, RNAfold, RNAalifold,RNAplfold, RNAcofold
...
def go_event():
    ...
    if Combo.get()== "RNAfold":
       if txt_seq.winfo_ismapped() == True:
         ...
         os.system("RNAfold < input.txt > output.txt")
         #find the ps file
         find_file()
       ...
       #else do this instead for file input
       else:
         with open(filepath, 'r') as fileread:
           file_contents = fileread.readlines()
           Contents = ''.join(file_contents)
         with open ("input.txt", "w") as usr_inp:
           usr_inp.write(Contents)
         os.system("RNAfold < input.txt > output.txt")
         #find the ps file
         find_file()
         #open the ps file on canvas      
         ...
         with open ("input.txt", "w") as usr_inp:
           usr_inp.write(Contents)
         os.system("RNAalifold < input.txt > output.txt")
         #find the ps file
         find_file()
         #open the ps file on canvas      
         open_file()
    ...
    if Combo.get()== "RNAplfold":
       if txt_seq.winfo_ismapped() == True:
         with open ("input.txt", "w") as usr_inp:
           usr_inp.write(txt_seq.get(1.0, "end-1c"))
         os.system("RNAplfold < input.txt > output.txt")
         #find the ps file
         find_file()
         #open the ps file on canvas      
         open_file()
    ...
    if Combo.get()== "RNAcofold":
       if txt_seq.winfo_ismapped() == True:
         txt_seq.insert(1.0, "<t\n")
         with open ("input.txt", "w") as usr_inp:
           usr_inp.write(txt_seq.get(2.0, "end-1c"))
         os.system("RNAcofold < input.txt > output.txt")
         #find the ps file
         find_file()
         #open the ps file on canvas      
         open_file()
...
def open_file():
    ...
    #Sequence and thermo info pull
    with open("output.txt",'r') as t:
       last = t.read().split(' ')[-1]
       thermo = last[0:-2]
       print (thermo+"kcal/mol")   
   
    with open("output.txt",'r') as s:
       seqinfo = s.readline()
       seq_len = len(seqinfo)-1
       print (seq_len)
    ...
    #Sequence Info text
    text_seqlbl = tk.Label(ps_window, text=("sequence length: ", str(seq_len)), bg="white", fg="black")
    text_seqlbl.place(x=img_w-180, y=img_h-25, anchor="nw")
    
    #minimum free energy label
    text_thermolbl = tk.Label(ps_window, text=("Minimum Free Energy: ", str(thermo), "kcal/mol"), bg="white", fg="black")
    text_thermolbl.place(x=img_w-280, y=img_h-28, anchor="sw")
...
#widget control function calls based on program selection
def click(event):
	global RNAlabel
...
#help button in main window to link to help doc
...
#drop down menu for program list
options = [" ","RNAfold"," ", "RNAalifold"," ", "RNAplfold"," ", "RNAcofold"]
